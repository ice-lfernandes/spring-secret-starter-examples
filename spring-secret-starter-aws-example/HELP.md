...
* The original package name 'br.com.ldf.medium.spring-secret-starter-aws-example' is invalid and this project uses 'br.com.ldf.medium.spring_secret_starter_aws_example' instead.
