...
* The original package name 'br.com.ldf.medium.spring-secret-starter-vault-example' is invalid and this project uses 'br.com.ldf.medium.spring_secret_starter_vault_example' instead.
